import { Controller, Get, Post, Body, Patch, Param, Delete, Query, Req, Res, UseGuards, NotFoundException } from '@nestjs/common';
...
export class AuthController {
  ...
  async login(
    ...
    await this.authService.getRefreshToken({user})
